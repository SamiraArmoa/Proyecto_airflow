...
int db_usuario_actualizar(void *db,
                          int id_us,
                          const char *nombre,
                          const char *email,
                          long long tlf,
...
int db_usuario_buscar_id(void *db,
                         int id_us,
                         char *nombre_out,
                         char *email_out,
                         long long *tlf_out,
...
int db_aeropuerto_actualizar(void *db,
                             int id_a,
                             const char *codigo,
                             const char *nombre,
                             const char *ciudad);

int db_aeropuerto_buscar_id(void *db,
                            int id_a,
                            char *codigo_out,
                            char *nombre_out,
                            char *ciudad_out);

int db_aeropuerto_buscar_codigo(void *db,
                                const char *codigo,
                                int *id_out,
                                char *nombre_out,
                                char *ciudad_out);
...
int db_vuelo_actualizar(void *db,
                        int id_vuelo,
                        const char *cod_vuelo,
                        int id_origen,
                        int id_destino,
...
int db_vuelo_buscar_id(void *db,
                       int *id_vuelo,
                       char *cod_vuelo_out,
                       int *id_origen_out,
                       int *id_destino_out,
...
int db_vuelo_asientos_disponibles(void *db,
                                  int id_vuelo,
                                  int *disp_out);
...
int db_billete_buscar_id(void *db,
                         int id_billete,
                         int *id_usuario_out,
                         int *id_vuelo_out,
                         char *asiento_out,
...
int db_equipaje_buscar_id(void *db,
                          int id_equipaje,
                          int *id_billete_out,
                          char *tipo_out,
                          double *peso_out,
